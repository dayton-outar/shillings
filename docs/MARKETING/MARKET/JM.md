...
|:--- |:--- |:--- |
| <p><strong>Market Issues</strong><br /><small>Identifies key issues driving and transforming your market from _customer_ and _offer_ perspectives</small></p> | <ul><li>What are the critical issues affecting the customer landscape?</li><li>Which shifts are underway?</li><li>Where is the market heading?</li></ul> | <ul><li>See [Critical Issues](#critical-issues)</li><li>See [Shifts Underway](#shifts-underway)</li><li>An increase in the number of short-term investors trading directly. There is a greater need for real-time information and speed of settling transactions.</li></ul> |
| <p><strong>Market Segments</strong><br /><small>Identifies the major market segments, describes their attractiveness, and seeks to spot new segments</small></p> | <ul><li>What are the most important _customer segments_?</li><li>Where is the biggest growth potential?</li><li>Which segments are declining?</li><li>Which peripheral segments deserve attention?</li></ul> | <ul><li>Is it the investors, the brokers or the listed companies? Maybe the investors and the listed companies. Brokers are just in the middle.</li><li>More investors will want to trade stocks (it's almost like another lottery) and more companies would want to be listed to get money from investors.</li><li>_Don't know. Good question to ask JCSD._</li><li>_Not sure yet_</li></ul> |
| <p><strong>Needs and Demands</strong><br /><small>Outlines market needs and analyzes how well business to competitors</small></p> | <ul><li>What do customers need?</li><li>Where are the biggest unsatisfied customer needs?</li><li>What do customers really want to get done?</li><li>Where is demand increasing? Declining?</li></ul> | <ul><li>Access to real-time trading. Technical analysis to make decisions. Quicker settlements of trades.</li><li>Access to real-time trading.</li><li>Make money from capital gains through short-term trading and dividends payments.</li><li>_Don't know yet. Ask JCSD._</li></ul> |
| <p><strong>Switching Costs</strong><br /><small>Describes elements related to customers switching business to competitors</small></p> | <ul><li>What binds customers to a company and its offer?</li><li>What switching costs prevent customers from defecting to competitors?</li><li>Is it easy for customers to find and purchase similar offers?</li><li>How important is brand?</li></ul> | <ul><li>There is </li>There is nothing that binds customer to a particular stock trading or analysis platform.<li>The value proposition of the app will have to maintain a way to get users hooked on using the app as a way to maintain loyalty.</li><li>Yes. It's easy to find and purchase similar offers.</li><li>It's competitive market. So brand is critical to customer equity</li></ul> |
