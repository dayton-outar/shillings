...
> 
> $\text{Value of loans} = $70 million (\text{PV of annuity}, 8 years, 6.5\%) + $1,000 million \over 1.065^8 = $1,030\text{ million}$
> 
...
> 
> $\text{Expected liquidation value} = $400 million(PV of annuity, 15 years @ 10\%) = $3.042 billion$
>
